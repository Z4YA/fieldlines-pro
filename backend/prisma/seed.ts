  ...
  interiorElements: {
    elements: [
      ...
      },
      {
        ...
        position: { x: '(field_width - 40.32) / 2', y: 0 },
        size: { width: 40.32, height: 16.5 },
      ...
      },
      {
        ...
        position: { x: '(field_width - 40.32) / 2', y: 'field_length - 16.5' },
        size: { width: 40.32, height: 16.5 },
        size_unit: 'meters_fixed',
      },
      {
        ...
        position: { x: '(field_width - 18.32) / 2', y: 0 },
        size: { width: 18.32, height: 5.5 },
        size_unit: 'meters_fixed',
      },
      {
        id: 'goal_area_bottom',
        ...
        position: { x: '(field_width - 18.32) / 2', y: 'field_length - 5.5' },
        size: { width: 18.32, height: 5.5 },
        size_unit: 'meters_fixed',
      },
      {
